  ...
  <div class="p-2">
      ...
      <div v-show="showSearch" class="mb-[10px]">
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            ...
            <el-form-item label="联系电话" prop="contactPhone" label-width="120px">
              <el-input v-model="queryParams.contactPhone" placeholder="请输入联系电话" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item label="经营主体名称" prop="companyName" label-width="120px">
              <el-input v-model="queryParams.companyName" placeholder="请输入经营主体名称" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item>
    ...
    <el-card shadow="hover">
      ...
      <el-table v-loading="loading" border :data="tenantList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="经营主体编号" align="center" prop="tenantId" />
        <el-table-column label="联系人" align="center" prop="contactUserName" />
        <el-table-column label="联系电话" align="center" prop="contactPhone" />
        <el-table-column label="经营主体名称" align="center" prop="companyName" />
...
<!--          </template>-->
<!--        </el-table-column>-->
        <el-table-column label="经营主体状态" align="center" prop="status">
          <template #default="scope">
        ...
        <el-table-column width="150" label="操作" align="center" fixed="right" class-name="small-padding fixed-width">
          <template #default="scope">
            ...
            <el-tooltip content="同步菜单权限" placement="top">
    ...
    <el-dialog v-model="dialog.visible" :title="dialog.title" width="500px" append-to-body>
      <el-form ref="tenantFormRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="经营主体名称" prop="companyName">
          <el-input v-model="form.companyName" placeholder="请输入经营主体名称" />
        </el-form-item>
        ...
        <el-form-item label="菜单权限" prop="packageId">
          <el-select v-model="form.packageId" :disabled="!!form.tenantId" placeholder="请选择菜单权限" clearable style="width: 100%">
